<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Lista de Horas</h2>
    </x-slot>
            ...
            <div class="bg-white shadow-sm sm:rounded-lg p-6">
                ...
                <div class="flex justify-between items-center mb-4 gap-4">
                    <div class="flex gap-4">
                        <a href="{{ route('horas.create') }}" class="btn btn-primary"><i class="bi bi-check-lg"></i>Crear
                            Hora</a>
                        <a href="{{ route('horas.index', ['ver_inactivas' => !$mostrarInactivas]) }}"
                ...
                <table class="w-full table-auto border-collapse border border-gray-200" id="mainTable">
                    <thead class="bg-gray-100">
                        <tr>
                            <th class="border border-gray-300 px-4 py-2 text-left">Hora de Inicio</th>
                            <th class="border border-gray-300 px-4 py-2 text-left">Hora de Fin</th>
                    ...
                    <tbody id="tableBody">
                        ...
                        @foreach ($horas as $hora)
                            <tr class="hover:bg-gray-50 transition">
                                <td class="border border-gray-300 px-4 py-2">{{ $hora->hora_inicio }}</td>
                                <td class="border border-gray-300 px-4 py-2">{{ $hora->hora_fin }}</td>
                                </td>
                                <td class="border border-gray-300 px-4 py-2">
                                    <a href="{{ route('horas.edit', $hora) }}" class="btn btn-warning"><i
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.delete-form').forEach(function(form) {
                form.addEventListener('submit', function(e) {
                    ...
                    Swal.fire({
                        title: "¿Estás seguro?",
                        text: "¡Vas a Desactivar estas horas academicas!",
                        icon: "warning",
