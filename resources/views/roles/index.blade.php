        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8" style="width: 60%;">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <!-- Tabla -->
                    <center>
                        <table class=" table-auto border-collapse border border-gray-200" id="mainTable">
                            ...
                            <tbody id="tableBody">
                                @if ($roles->isEmpty())
                                    <tr>
                                        <td colspan="6" class="border px-4 py-2 text-center">No hay Roles
                                            registrados.</td>
                                    </tr>
                                @endif
                                @foreach ($roles as $role)
                                    <tr class="hover:bg-gray-50 transition">
                                        ...
                                        <td class="border border-gray-300 px-4 py-2">
                                            <button
                                                class="btn btn-warning inline-flex  rounded hover:bg-yellow-400 transition"
                                                onclick="window.location.href='{{ route('roles.edit', $role->id) }}'"><i
