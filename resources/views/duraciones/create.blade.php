<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Crear Duración</h2>
    </x-slot>
            ...
            <div class="bg-white shadow-sm sm:rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('duraciones.store') }}">
                    ...
                    <div class="flex items-center justify-end mt-4">
                        ...
                        <button id="submitButton" class="btn btn-primary ms-4" disabled><i class="bi bi-check-lg"></i> Crear Duración</button>
                    </div>
                </form>
            </div>
        </div>
