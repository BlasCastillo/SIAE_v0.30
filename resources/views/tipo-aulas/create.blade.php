<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Crear Tipo de Aula</h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm sm:rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('tipo-aulas.store') }}">
                    @csrf
                    ...
                    <div class="flex items-center justify-end mt-4">
                        ...
                        <button id="submitButton" class="btn btn-primary ms-4" disabled> <i class="bi bi-check-lg"></i> Crear Tipo de Aula</button>
                    </div>
                </form>
            </div>
        </div>
