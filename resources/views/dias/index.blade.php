<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Lista de Días</h2>
    </x-slot>
            ...
            <div class="bg-white shadow-sm sm:rounded-lg p-6">
                ...
                <div class="flex justify-between items-center mb-4 gap-4">
                    <div class="flex gap-4">
                        <a href="{{ route('dias.create') }}" class="btn btn-primary"> <i class="bi bi-plus-lg"></i>Crear
                            Día</a>
                        <a href="{{ route('dias.index', ['ver_inactivos' => !$mostrarInactivos]) }}"
                ...
                <center>
                    <table class="w-full table-auto border-collapse border border-gray-200" id="mainTable">
                        ...
                        <tbody id="tableBody">
                            @if ($dias->isEmpty())
                                <tr>
                                    <td colspan="6" class="border px-4 py-2 text-center">No hay Dias registrados.
                                    </td>
                                </tr>
                            @endif
                            @foreach ($dias as $dia)
                                <tr class="hover:bg-gray-50 transition">
                                    <td class="border border-gray-300 px-4 py-2">{{ $dia->nombre }}</td>
                                    <td class="border border-gray-300 px-4 py-2">
                                        <a href="{{ route('dias.edit', $dia) }}" class="btn btn-warning"><i
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                document.querySelectorAll('.delete-form').forEach(function(form) {
                    form.addEventListener('submit', function(e) {
                        ...
                        Swal.fire({
                            title: "¿Estás seguro?",
                            text: "¡Vas a Desactivar este dia!",
                            icon: "warning",
